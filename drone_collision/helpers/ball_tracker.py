...
# supplied with the portion of the frame relevant to analysis,
# segment balls and return centers and radii
def ball_tracker(frame):

    # HSV range values for various ball colors
    colorRanges = [
    ((40, 13, 77), (80, 255, 255), "green"),
